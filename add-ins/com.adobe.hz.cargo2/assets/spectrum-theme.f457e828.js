import{F as m,g as l}from"./vendor.6b255b86.js";const u=["spectrum","express"],p=["medium","large","medium-express","large-express"],b=["light","lightest","dark","darkest","light-express","lightest-express","dark-express","darkest-express"];class i extends HTMLElement{constructor(){super(),this._theme="spectrum",this._color="",this._scale="",this.trackedChildren=new Set,this._updateRequested=!1,this._contextConsumers=new Map,this.attachShadow({mode:"open"});const t=document.importNode(i.template.content,!0);this.shadowRoot.appendChild(t),this.shouldAdoptStyles(),this.addEventListener("sp-query-theme",this.onQueryTheme),this.addEventListener("sp-language-context",this._handleContextPresence),this.updateComplete=this.__createDeferredPromise()}static get observedAttributes(){return["color","scale","theme","lang"]}attributeChangedCallback(t,e,o){e!==o&&(t==="color"?this.color=o:t==="scale"?this.scale=o:t==="lang"&&!!o?(this.lang=o,this._provideContext()):t==="theme"&&(this.theme=o))}requestUpdate(){window.ShadyCSS!==void 0&&!window.ShadyCSS.nativeShadow?window.ShadyCSS.styleElement(this):this.shouldAdoptStyles()}get theme(){const t=i.themeFragmentsByKind.get("theme"),{name:e}=t&&t.get("default")||{};return this._theme||e||""}set theme(t){if(t===this._theme)return;const e=!!t&&u.includes(t)?t:this.theme;e!==this._theme&&(this._theme=e,this.requestUpdate()),e?this.setAttribute("theme",e):this.removeAttribute("theme")}get color(){const t=i.themeFragmentsByKind.get("color"),{name:e}=t&&t.get("default")||{};return this._color||e||""}set color(t){if(t===this._color)return;const e=!!t&&b.includes(t)?t:this.color;e!==this._color&&(this._color=e,this.requestUpdate()),e?this.setAttribute("color",e):this.removeAttribute("color")}get scale(){const t=i.themeFragmentsByKind.get("scale"),{name:e}=t&&t.get("default")||{};return this._scale||e||""}set scale(t){if(t===this._scale)return;const e=!!t&&p.includes(t)?t:this.scale;e!==this._scale&&(this._scale=e,this.requestUpdate()),e?this.setAttribute("scale",e):this.removeAttribute("scale")}get styles(){const t=[...i.themeFragmentsByKind.keys()],e=(a,s,r)=>{const c=r&&r!=="theme"&&this.theme==="express"?a.get(`${s}-express`):a.get(s),n=s==="spectrum"||!r||this.hasAttribute(r);if(c&&n)return c.styles};return[...t.reduce((a,s)=>{const r=i.themeFragmentsByKind.get(s);let c;if(s==="app"||s==="core")c=e(r,s);else{const{[s]:n}=this;c=e(r,n,s)}return c&&a.push(c),a},[])]}static get template(){return this.templateElement||(this.templateElement=document.createElement("template"),this.templateElement.innerHTML="<slot></slot>"),this.templateElement}__createDeferredPromise(){return new Promise(t=>{this.__resolve=t})}onQueryTheme(t){if(t.defaultPrevented)return;t.preventDefault();const{detail:e}=t;e.color=this.color||void 0,e.scale=this.scale||void 0,e.lang=this.lang||document.documentElement.lang||navigator.language,e.theme=this.theme||void 0}connectedCallback(){this.shouldAdoptStyles(),window.ShadyCSS!==void 0&&window.ShadyCSS.styleElement(this),i.instances.add(this);const t=()=>{const{dir:e}=this;this.trackedChildren.forEach(o=>{o.setAttribute("dir",e==="rtl"?e:"ltr")})};if(this.observer||(this.observer=new MutationObserver(t)),this.observer.observe(this,{attributes:!0,attributeFilter:["dir"]}),!this.hasAttribute("dir")){let e=this.assignedSlot||this.parentNode;for(;e!==document.documentElement&&!(e instanceof i);)e=e.assignedSlot||e.parentNode||e.host;this.dir=e.dir==="rtl"?e.dir:"ltr"}requestAnimationFrame(()=>t())}disconnectedCallback(){i.instances.delete(this),this.observer.disconnect()}startManagingContentDirection(t){this.trackedChildren.add(t)}stopManagingContentDirection(t){this.trackedChildren.delete(t)}async shouldAdoptStyles(){this._updateRequested||(this.updateComplete=this.__createDeferredPromise(),this._updateRequested=!0,this._updateRequested=await!1,this.adoptStyles(),this.__resolve(!0))}adoptStyles(){const t=this.styles;if(window.ShadyCSS!==void 0&&!window.ShadyCSS.nativeShadow&&window.ShadyCSS.ScopingShim){const e=[];for(const[o,a]of i.themeFragmentsByKind)for(const[s,{styles:r}]of a){if(s==="default")continue;let c=r.cssText;i.defaultFragments.has(s)||(c=c.replace(":host",`:host([${o}='${s}'])`)),e.push(c)}window.ShadyCSS.ScopingShim.prepareAdoptedCssText(e,this.localName),window.ShadyCSS.prepareTemplate(i.template,this.localName)}else if(m){const e=[];for(const o of t)e.push(o.styleSheet);this.shadowRoot.adoptedStyleSheets=e}else this.shadowRoot.querySelectorAll("style").forEach(o=>o.remove()),t.forEach(o=>{const a=document.createElement("style");a.textContent=o.cssText,this.shadowRoot.appendChild(a)})}static registerThemeFragment(t,e,o){const a=i.themeFragmentsByKind.get(e)||new Map;a.size===0&&(i.themeFragmentsByKind.set(e,a),a.set("default",{name:t,styles:o}),i.defaultFragments.add(t)),a.set(t,{name:t,styles:o}),i.instances.forEach(s=>s.shouldAdoptStyles())}_provideContext(){this._contextConsumers.forEach(t=>t(this.lang))}_handleContextPresence(t){const e=t.composedPath()[0];if(this._contextConsumers.has(e))this._contextConsumers.delete(e);else{this._contextConsumers.set(e,t.detail.callback);const o=this._contextConsumers.get(e);o&&o(this.lang||document.documentElement.lang||navigator.language)}}}i.themeFragmentsByKind=new Map;i.defaultFragments=new Set(["spectrum"]);i.instances=new Set;customElements.define("sp-theme",i);const d=l`
...
`;var x=h;i.registerThemeFragment("spectrum","theme",x);i.registerThemeFragment("light","color",g);const v=l`
...
`;var z=v;i.registerThemeFragment("lightest","color",z);const y=l`
...
`;var f=y;i.registerThemeFragment("dark","color",f);const k=l`
...
`;var w=k;i.registerThemeFragment("darkest","color",w);const q=l`
...
`;var S=q;i.registerThemeFragment("medium","scale",S);const C=l`
...
`;var F=C;i.registerThemeFragment("large","scale",F);
